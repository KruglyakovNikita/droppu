...
const Home: React.FC = () => {
  ...
  const inviteFriendsLink = () => {
    window.Telegram.WebApp.openTelegramLink(`https://telegram.me/share/url?url=https://t.me/droppu/start?startapp=${telegramUser?.id}&text=%0A%0A🚀 Jump into action with @Droppu's jetpack game and earn $JET tokens soon!%0A🌟 Get a 750 rating boost just for joining!%0A💥 Premium players score a massive 1000 rating boost!`);
  }
